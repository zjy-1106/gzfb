...
class AsyncConsumer(object):
    ...
    """
    EXCHANGE_TYPE = ExchangeType.fanout     # 指定exchange类型
    ...
    def on_channel_open(self, channel):
        ...
        self.setup_exchange(self.mq_cfg['exchange'])
    ...
    def setup_queue(self, queue_name):
        ...
        self._channel.queue_declare(queue=queue_name, durable=False, arguments={'x-expires': 3600*1000*24}, callback=cb)
    ...
    def on_bindok(self, _unused_frame, userdata):
        ...
        """
        # self.set_qos()
        cb = functools.partial(self.on_basic_qos_ok, userdata=userdata)
    ...
    def on_message(self, _unused_channel, basic_deliver, properties, body):
        ...
        """
        handle_msg(json.loads(body.decode('utf-8')))
...
class ReconnectConsumer(object):
    ...
    def __init__(self, amqp_url, queue):
        ...
        self._queue = queue
        self._consumer = AsyncConsumer(self._amqp_url, self._queue)
